...
public unsafe class DesktopGlApi : IGlApi
{
	...
	public DesktopGlApi(ProcGetProcAddress procGetProcAddress)
	{
	...
	public void Enable(Cap cap) => glEnable(cap);
	public void Disable(Cap cap) => glDisable(cap);
	public void BlendFunc(BlendFactor sfactor, BlendFactor dfactor) => glBlendFunc(sfactor, dfactor);
}
